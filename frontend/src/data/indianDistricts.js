// Official districts of Indian States and Union Territories (Census of India / Local Government Directory)
export const STATE_DISTRICTS = {
  ...
  'Madhya Pradesh': [
    ...
    'Mandsaur', 'Mauganj', 'Morena', 'Narsinghpur', 'Neemuch', 'Niwari', 'Panna',
  ...
  'Maharashtra': [
    ...
    'Chhatrapati Sambhajinagar (Aurangabad)', 'Dharashiv (Osmanabad)', 'Dhule',
